...
const Services = () => {
  ...
  useSeo({
    title: isRTL
      ? "فكرة | منصة تعليم إلكتروني عالمية"
      : "Fekra | Global E-Learning Platform",
    description: isRTL
      ? "فكرة منصة تعليم إلكتروني عالمية تساعد المتعلمين على اكتشاف الدورات المناسبة، والتطبيق باستمرار، ومتابعة التقدم بوضوح."
  ...
  const text = useMemo(
    () => ({
      ar: {
        ...
        subtitle: "نساعد المتعلمين على فهم المحتوى بسرعة، والتطبيق مباشرة، ومتابعة تقدّمهم بوضوح.",
