...
export const normalizeDigitsToEnglish = (value) =>
  String(value ?? "")
    .replace(/[٠-٩]/g, (digit) => String(ARABIC_DIGITS.indexOf(digit)))
    .replace(/[۰-۹]/g, (digit) => String(PERSIAN_DIGITS.indexOf(digit)))

export const sanitizeEgyptianPhoneInput = (value) =>
...
export const isValidEgyptianPhoneNumber = (value) =>
  /^(\+20\d{10}|0\d{10}|\d{10})$/.test(sanitizeEgyptianPhoneInput(value))

export const normalizeEgyptianPhoneNumber = (value) => {
