...
export const getCenterDataByType = async (centerId, type) => {
  try {
    ...
    const response = await axios.get(`/centers/${centerId}/${type}`, {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
...
export const getCenterTimetable = async (centerId) => {
  try {
    ...
    const response = await axios.get(`/centers/${centerId}/timetable`, {
        withCredentials: true,
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
...
export const createLecturer = async (lecturerData) => {
  try {
    ...
    const response = await axios.post(`/center-lecturer/`, lecturerData, {
      withCredentials: true,
      headers: {
