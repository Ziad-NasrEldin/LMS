...
export const getAllCoupons = async () => {
  try {
    ...
    const response = await axios.get(`/ec/coupons`, {
...
export const getActiveCoupons = async () => {
  try {
    ...
    const response = await axios.get(`/ec/coupons/active`, {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${getToken()}`,
      },
...
export const getUsedCoupons = async () => {
  try {
    ...
    const response = await axios.get(`/ec/coupons/used`, {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${getToken()}`,
      },
...
export const getCouponById = async (couponId) => {
  try {
    ...
    const response = await axios.get(`/ec/coupons/${couponId}`, {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${getToken()}`,
      },
...
export const createCoupon = async (couponData) => {
  try {
    ...
    const response = await axios.post(`/ec/coupons`, couponData, {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${getToken()}`,
...
export const deleteCoupon = async (couponId) => {
  try {
    ...
    const response = await axios.delete(`/ec/coupons/${couponId}`, {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${getToken()}`,
      },
