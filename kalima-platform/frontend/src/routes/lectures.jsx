...
export const getAllLecturesPublic = async (queryParams = {}) => {
  try {
    const response = await axios.get(`/lectures/public`, {
      params: queryParams,
      withCredentials: true,
...
export const getAllContainersPublic = async () => {
  try {
    const response = await axios.get(`/containers/public`, {
      withCredentials: true,
...
export const purchaseContainer = async (containerId) => {
  try {
    const response = await axios.post(`/purchases/container`, 
...
export const getLectureAttachments = async (lectureId) => {
  try {
    ...
    const response = await axios.get(`/lectures/attachments/${lectureId}`, {
      headers: {
...
export const deleteLecture = async (lectureId) => {
  try {
    ...
    const response = await axios.delete(`/lectures/${lectureId}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    })
...
export const downloadAttachmentById = async (attachmentId) => {
  try {
    ...
    const response = await axios.get(`/lectures/attachment/${attachmentId}/file`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
export const getMyContainers = async () => {
  try {
    const response = await axios.get(`/containers/my-containers`, {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${getToken()}`,
      },
...
export const getContainersByLecturerId = async (lecturerId) => {
  try {
    const response = await axios.get(`/containers/lecturer/${lecturerId}`, {
      withCredentials: true,
      headers: {
        Authorization: `Bearer ${getToken()}`,
      },
...
export const createLectureAttachment = async (lectureId, attachmentData, isFormData = false) => {
  try {
    ...
    const response = await axios.post(
      `/lectures/attachments/${lectureId}`,
      formData,
      {
        withCredentials: true,
        headers: {
