...
const { buildOtpEmailTemplate, EMAIL_TYPES } = require('../utils/emailVerification/emailTemplates');
...
exports.requestPasswordReset = catchAsync(async (req, res, next) => {
  ...
  try {
    ...
    const { subject, html } = buildOtpEmailTemplate({ type: EMAIL_TYPES.password_reset, otp });
